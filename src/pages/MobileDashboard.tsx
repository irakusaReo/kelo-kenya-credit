...
const MobileDashboard = () => {
  ...
  const quickActions = [
    ...
    { icon: Building2, label: 'Bank Transfer', path: '/transfer' },
    { icon: ArrowUpRight, label: 'Mobile to I&M', path: '/mobile-transfer' },
      ...
      <div className="px-6 pt-12 pb-8">
        ...
        <Card className="bg-gradient-to-r from-purple-500 to-indigo-600 border-0 text-white overflow-hidden relative">
          <CardContent className="p-6">
            ...
            <div className="mb-4">
              <p className="font-bold text-xl">{user?.name || 'Andre Aila Owano'}</p>
              <p className="text-white/80">0170 6973 5661 50</p>
            </div>
          ...
          <Card className="bg-white/95 backdrop-blur hover:bg-white transition-colors">
            <CardContent className="p-4 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium">View My Card</span>
              </div>
