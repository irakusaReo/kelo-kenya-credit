      ...
      <div className="kelo-container py-12 md:py-16">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/consumer" className="text-gray-400 hover:text-white">For Consumers</Link>
              </li>
              <li>
                <Link to="/merchant" className="text-gray-400 hover:text-white">For Merchants</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/responsible" className="text-gray-400 hover:text-white">Responsible Lending</Link>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          <p className="text-base text-gray-400 text-center">
            &copy; {new Date().getFullYear()} Kelo Kenya. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
